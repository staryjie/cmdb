...
type CreateTaskRequst struct {
	...
	// 任务类型
	// @gotags: json:"type"
	Type Type `protobuf:"varint,1,opt,name=type,proto3,enum=staryjie.cmdb.task.Type" json:"type"`
	// 测试运行
	// @gotags: json:"dry_run"
	...
	ResourceType resource.Type `protobuf:"varint,4,opt,name=resource_type,json=resourceType,proto3,enum=staryjie.cmdb.resource.Type" json:"resource_type"`
	// 通知资源的Region
	// @gotags: json:"region"
...
type Status struct {
	...
	// 任务状态
	// @gotags: json:"stage"
	Stage Stage `protobuf:"varint,1,opt,name=stage,proto3,enum=staryjie.cmdb.task.Stage" json:"stage"`
	// 失败时的异常信息
	// @gotags: json:"message"
...
type QueryTaskRequest struct {
	...
	// 更加资源类型来过滤任务
	// @gotags: json:"resource_type"
	ResourceType resource.Type `protobuf:"varint,3,opt,name=resource_type,json=resourceType,proto3,enum=staryjie.cmdb.resource.Type" json:"resource_type"`
...
var file_apps_task_pb_task_proto_rawDesc = []byte{
	...
	0x61, 0x73, 0x6b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x12, 0x73, 0x74, 0x61, 0x72, 0x79,
	0x6a, 0x69, 0x65, 0x2e, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x74, 0x61, 0x73, 0x6b, 0x1a, 0x1f, 0x61,
	...
	0x2e, 0x73, 0x74, 0x61, 0x72, 0x79, 0x6a, 0x69, 0x65, 0x2e, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x74,
	0x61, 0x73, 0x6b, 0x2e, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22,
	0xb3, 0x01, 0x0a, 0x04, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01,
	...
	0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x38, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x73, 0x74, 0x61, 0x72, 0x79, 0x6a, 0x69, 0x65,
	...
	0x61, 0x12, 0x32, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x1a, 0x2e, 0x73, 0x74, 0x61, 0x72, 0x79, 0x6a, 0x69, 0x65, 0x2e, 0x63, 0x6d, 0x64,
	0x62, 0x2e, 0x74, 0x61, 0x73, 0x6b, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xf0, 0x02, 0x0a, 0x10, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x54, 0x61, 0x73, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x73, 0x74, 0x12, 0x2c, 0x0a, 0x04, 0x74, 0x79,
	0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x18, 0x2e, 0x73, 0x74, 0x61, 0x72, 0x79,
	0x6a, 0x69, 0x65, 0x2e, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x74, 0x61, 0x73, 0x6b, 0x2e, 0x54, 0x79,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x49, 0x64, 0x12, 0x41,
	0x0a, 0x0d, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x73, 0x74, 0x61, 0x72, 0x79, 0x6a, 0x69, 0x65,
	...
	,
	...
	0x61, 0x6c, 0x46, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x22, 0xa9, 0x01, 0x0a, 0x10, 0x51, 0x75, 0x65,
	...
	0x04, 0x70, 0x61, 0x67, 0x65, 0x12, 0x41, 0x0a, 0x0d, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x73,
	...
	0x6f, 0x72, 0x64, 0x73, 0x22, 0x25, 0x0a, 0x13, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65,
	0x54, 0x61, 0x73, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x2a, 0x2f, 0x0a, 0x04, 0x54,
	0x79, 0x70, 0x65, 0x12, 0x11, 0x0a, 0x0d, 0x52, 0x45, 0x53, 0x4f, 0x55, 0x52, 0x43, 0x45, 0x5f,
	0x53, 0x59, 0x4e, 0x43, 0x10, 0x00, 0x12, 0x14, 0x0a, 0x10, 0x52, 0x45, 0x53, 0x4f, 0x55, 0x52,
	0x43, 0x45, 0x5f, 0x52, 0x45, 0x4c, 0x45, 0x41, 0x53, 0x45, 0x10, 0x01, 0x2a, 0x48, 0x0a, 0x05,
	...
	,
...
var file_apps_task_pb_task_proto_goTypes = []interface{}{
	(Type)(0),                   // 0: staryjie.cmdb.task.Type
	(Stage)(0),                  // 1: staryjie.cmdb.task.Stage
	(*TaskSet)(nil),             // 2: staryjie.cmdb.task.TaskSet
	(*Task)(nil),                // 3: staryjie.cmdb.task.Task
	(*CreateTaskRequst)(nil),    // 4: staryjie.cmdb.task.CreateTaskRequst
	(*Status)(nil),              // 5: staryjie.cmdb.task.Status
	(*QueryTaskRequest)(nil),    // 6: staryjie.cmdb.task.QueryTaskRequest
	(*DescribeTaskRequest)(nil), // 7: staryjie.cmdb.task.DescribeTaskRequest
	nil,                         // 8: staryjie.cmdb.task.CreateTaskRequst.ParamsEntry
	(resource.Type)(0),          // 9: staryjie.cmdb.resource.Type
	(*request.PageRequest)(nil), // 10: infraboard.mcube.page.PageRequest
}
var file_apps_task_pb_task_proto_depIdxs = []int32{
	3,  // 0: staryjie.cmdb.task.TaskSet.items:type_name -> staryjie.cmdb.task.Task
	4,  // 1: staryjie.cmdb.task.Task.data:type_name -> staryjie.cmdb.task.CreateTaskRequst
	5,  // 2: staryjie.cmdb.task.Task.status:type_name -> staryjie.cmdb.task.Status
	0,  // 3: staryjie.cmdb.task.CreateTaskRequst.type:type_name -> staryjie.cmdb.task.Type
	9,  // 4: staryjie.cmdb.task.CreateTaskRequst.resource_type:type_name -> staryjie.cmdb.resource.Type
	8,  // 5: staryjie.cmdb.task.CreateTaskRequst.params:type_name -> staryjie.cmdb.task.CreateTaskRequst.ParamsEntry
	1,  // 6: staryjie.cmdb.task.Status.stage:type_name -> staryjie.cmdb.task.Stage
	10, // 7: staryjie.cmdb.task.QueryTaskRequest.page:type_name -> infraboard.mcube.page.PageRequest
	9,  // 8: staryjie.cmdb.task.QueryTaskRequest.resource_type:type_name -> staryjie.cmdb.resource.Type
	4,  // 9: staryjie.cmdb.task.Service.CreateTask:input_type -> staryjie.cmdb.task.CreateTaskRequst
	6,  // 10: staryjie.cmdb.task.Service.QueryTask:input_type -> staryjie.cmdb.task.QueryTaskRequest
	7,  // 11: staryjie.cmdb.task.Service.DescribeTask:input_type -> staryjie.cmdb.task.DescribeTaskRequest
	3,  // 12: staryjie.cmdb.task.Service.CreateTask:output_type -> staryjie.cmdb.task.Task
	2,  // 13: staryjie.cmdb.task.Service.QueryTask:output_type -> staryjie.cmdb.task.TaskSet
	3,  // 14: staryjie.cmdb.task.Service.DescribeTask:output_type -> staryjie.cmdb.task.Task
