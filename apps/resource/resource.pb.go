...
const (
	...
	// 第三方定义的标签, 比如云商同步过来的标签，本系统不允许修改，去第三方云商修改之后同步过来
...
type SearchRequest struct {
	...
	// 使用方式， optional protoc编译之后 --> 指针类型，意思就是允许为空指针
	// @gotags: json:"usage_mode"
	UsageMode *UsageMode `protobuf:"varint,5,opt,name=usage_mode,json=usageMode,proto3,enum=staryjie.cmdb.resource.UsageMode,oneof" json:"usage_mode"`
	// 厂商
	// @gotags: json:"vendor"
	Vendor *Vendor `protobuf:"varint,6,opt,name=vendor,proto3,enum=staryjie.cmdb.resource.Vendor,oneof" json:"vendor"`
	// 同步的账号
	...
	// 资源类型
	// @gotags: json:"type"
	Type *Type `protobuf:"varint,8,opt,name=type,proto3,enum=staryjie.cmdb.resource.Type,oneof" json:"type"`
	// 服务商中的状态
	// @gotags: json:"status"
	...
	// 是否返回资源的标签，如果标签很多，但是不想要，可以通过该字段控制是否返回标签
	// 提升查询效率，提高性能，减少不必要数据的传输
...
type UpdateTagRequest struct {
	...
	// 资源id
	// @gotags: json:"action"
	Action UpdateAction `protobuf:"varint,2,opt,name=action,proto3,enum=staryjie.cmdb.resource.UpdateAction" json:"action"`
	// 需要添加的资源标签
...
type Base struct {
	...
	// 全局唯一Id, 直接使用个云商自己的Id，在云商也是唯一的
	// @gotags: json:"id" validate:"required"
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id" validate:"required"`
	// 同步时间，资源是什么时候被录入到CMDB系统
	// @gotags: json:"sync_at"
	SyncAt int64 `protobuf:"varint,2,opt,name=sync_at,json=syncAt,proto3" json:"sync_at"`
	// 用于同步的凭证ID，需要凭证才可以读取或操作云商的资源
	// @gotags: json:"secret_id"
	SecretId string `protobuf:"bytes,3,opt,name=secret_id,json=secretId,proto3" json:"secret_id"`
	// 厂商
	// @gotags: json:"vendor"
	Vendor Vendor `protobuf:"varint,4,opt,name=vendor,proto3,enum=staryjie.cmdb.resource.Vendor" json:"vendor"`
	// 资源类型
	// @gotags: json:"resource_type"
	ResourceType Type `protobuf:"varint,5,opt,name=resource_type,json=resourceType,proto3,enum=staryjie.cmdb.resource.Type" json:"resource_type"`
	// 地域
	// @gotags: json:"region"
	...
	// 基础数据Hash，通用属性Hash，通过对比Hash值是否变化来判断是否需要执行其他操作，提升效率
	...
	// 描述数据Hash，资源特有属性，就是其他的模型表，比如主机表中的GPU
	...
	// 资源所属空间，属于哪个项目，后期和权限系统挂钩，参照Kubernetes
	// @gotags: json:"namespace"
	...
	// 使用方式（可选）
	// @gotags: json:"usage_mode"
	UsageMode UsageMode `protobuf:"varint,16,opt,name=usage_mode,json=usageMode,proto3,enum=staryjie.cmdb.resource.UsageMode" json:"usage_mode"`
...
type Tag struct {
	...
	// 标签属于的资源，通过 resource_id 进行关联
	// @gotags: json:"resource_id"
	ResourceId string `protobuf:"bytes,1,opt,name=resource_id,json=resourceId,proto3" json:"resource_id"`
	// 标签的类型
	// @gotags: json:"type"
	Type TagType `protobuf:"varint,2,opt,name=type,proto3,enum=staryjie.cmdb.resource.TagType" json:"type"`
	// 标签的Key
...
var file_apps_resource_pb_resource_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x16, 0x73, 0x74, 0x61, 0x72, 0x79, 0x6a, 0x69, 0x65, 0x2e, 0x63, 0x6d, 0x64, 0x62,
	...
	0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x22, 0xbb,
	...
	0x12, 0x45, 0x0a, 0x0a, 0x75, 0x73, 0x61, 0x67, 0x65, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x21, 0x2e, 0x73, 0x74, 0x61, 0x72, 0x79, 0x6a, 0x69, 0x65, 0x2e,
	...
	0x4d, 0x6f, 0x64, 0x65, 0x88, 0x01, 0x01, 0x12, 0x3b, 0x0a, 0x06, 0x76, 0x65, 0x6e, 0x64, 0x6f,
	0x72, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1e, 0x2e, 0x73, 0x74, 0x61, 0x72, 0x79, 0x6a,
	0x69, 0x65, 0x2e, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	...
	0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x35, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18,
	0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x73, 0x74, 0x61, 0x72, 0x79, 0x6a, 0x69, 0x65,
	...
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x37, 0x0a, 0x04, 0x74, 0x61, 0x67, 0x73, 0x18, 0x0a,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x73, 0x74, 0x61, 0x72, 0x79, 0x6a, 0x69, 0x65, 0x2e,
	...
	0x64, 0x6f, 0x72, 0x42, 0x07, 0x0a, 0x05, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x22, 0x34, 0x0a, 0x0f,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x2f, 0x0a, 0x04, 0x74, 0x61, 0x67, 0x73, 0x18, 0x07,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x73, 0x74, 0x61, 0x72, 0x79, 0x6a, 0x69, 0x65, 0x2e,
	0x63, 0x6d, 0x64, 0x62, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x54, 0x61,
	...
	0x0c, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x61, 0x79, 0x54, 0x79, 0x70, 0x65, 0x22, 0x51,
	...
	,
	...
	0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x68, 0x69, 0x64, 0x64, 0x65, 0x6e, 0x12, 0x39, 0x0a, 0x04,
	0x6d, 0x65, 0x74, 0x61, 0x18, 0x0f, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x73, 0x74, 0x61,
	0x72, 0x79, 0x6a, 0x69, 0x65, 0x2e, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75,
	...
	0x4f, 0x56, 0x45, 0x10, 0x01, 0x2a, 0x46, 0x0a, 0x06, 0x56, 0x65, 0x6e, 0x64, 0x6f, 0x72, 0x12,
	...
	,
	...
	0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x74, 0x61, 0x72, 0x79, 0x6a, 0x69, 0x65, 0x2f, 0x63, 0x6d, 0x64,
...
var file_apps_resource_pb_resource_proto_goTypes = []interface{}{
	(UpdateAction)(0),           // 0: staryjie.cmdb.resource.UpdateAction
	(Vendor)(0),                 // 1: staryjie.cmdb.resource.Vendor
	(Type)(0),                   // 2: staryjie.cmdb.resource.Type
	(UsageMode)(0),              // 3: staryjie.cmdb.resource.UsageMode
	(TagType)(0),                // 4: staryjie.cmdb.resource.TagType
	(*TagSelector)(nil),         // 5: staryjie.cmdb.resource.TagSelector
	(*SearchRequest)(nil),       // 6: staryjie.cmdb.resource.SearchRequest
	(*QueryTagRequest)(nil),     // 7: staryjie.cmdb.resource.QueryTagRequest
	(*UpdateTagRequest)(nil),    // 8: staryjie.cmdb.resource.UpdateTagRequest
	(*ResourceSet)(nil),         // 9: staryjie.cmdb.resource.ResourceSet
	(*Resource)(nil),            // 10: staryjie.cmdb.resource.Resource
	(*SharedPolicy)(nil),        // 11: staryjie.cmdb.resource.SharedPolicy
	(*Base)(nil),                // 12: staryjie.cmdb.resource.Base
	(*Information)(nil),         // 13: staryjie.cmdb.resource.Information
	(*TagSet)(nil),              // 14: staryjie.cmdb.resource.TagSet
	(*Tag)(nil),                 // 15: staryjie.cmdb.resource.Tag
	nil,                         // 16: staryjie.cmdb.resource.Tag.MetaEntry
	(*request.PageRequest)(nil), // 17: infraboard.mcube.page.PageRequest
}
var file_apps_resource_pb_resource_proto_depIdxs = []int32{
	17, // 0: staryjie.cmdb.resource.SearchRequest.page:type_name -> infraboard.mcube.page.PageRequest
	3,  // 1: staryjie.cmdb.resource.SearchRequest.usage_mode:type_name -> staryjie.cmdb.resource.UsageMode
	1,  // 2: staryjie.cmdb.resource.SearchRequest.vendor:type_name -> staryjie.cmdb.resource.Vendor
	2,  // 3: staryjie.cmdb.resource.SearchRequest.type:type_name -> staryjie.cmdb.resource.Type
	5,  // 4: staryjie.cmdb.resource.SearchRequest.tags:type_name -> staryjie.cmdb.resource.TagSelector
	0,  // 5: staryjie.cmdb.resource.UpdateTagRequest.action:type_name -> staryjie.cmdb.resource.UpdateAction
	15, // 6: staryjie.cmdb.resource.UpdateTagRequest.tags:type_name -> staryjie.cmdb.resource.Tag
	10, // 7: staryjie.cmdb.resource.ResourceSet.items:type_name -> staryjie.cmdb.resource.Resource
	12, // 8: staryjie.cmdb.resource.Resource.base:type_name -> staryjie.cmdb.resource.Base
	13, // 9: staryjie.cmdb.resource.Resource.information:type_name -> staryjie.cmdb.resource.Information
	1,  // 10: staryjie.cmdb.resource.Base.vendor:type_name -> staryjie.cmdb.resource.Vendor
	2,  // 11: staryjie.cmdb.resource.Base.resource_type:type_name -> staryjie.cmdb.resource.Type
	3,  // 12: staryjie.cmdb.resource.Base.usage_mode:type_name -> staryjie.cmdb.resource.UsageMode
	11, // 13: staryjie.cmdb.resource.Base.shared_policy:type_name -> staryjie.cmdb.resource.SharedPolicy
	15, // 14: staryjie.cmdb.resource.Information.tags:type_name -> staryjie.cmdb.resource.Tag
	15, // 15: staryjie.cmdb.resource.TagSet.items:type_name -> staryjie.cmdb.resource.Tag
	4,  // 16: staryjie.cmdb.resource.Tag.type:type_name -> staryjie.cmdb.resource.TagType
	16, // 17: staryjie.cmdb.resource.Tag.meta:type_name -> staryjie.cmdb.resource.Tag.MetaEntry
	6,  // 18: staryjie.cmdb.resource.Service.Search:input_type -> staryjie.cmdb.resource.SearchRequest
	7,  // 19: staryjie.cmdb.resource.Service.QueryTag:input_type -> staryjie.cmdb.resource.QueryTagRequest
	8,  // 20: staryjie.cmdb.resource.Service.UpdateTag:input_type -> staryjie.cmdb.resource.UpdateTagRequest
	9,  // 21: staryjie.cmdb.resource.Service.Search:output_type -> staryjie.cmdb.resource.ResourceSet
	14, // 22: staryjie.cmdb.resource.Service.QueryTag:output_type -> staryjie.cmdb.resource.TagSet
	10, // 23: staryjie.cmdb.resource.Service.UpdateTag:output_type -> staryjie.cmdb.resource.Resource
